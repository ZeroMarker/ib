...
export default function OverviewPage({ overview, openOrders, filledOrders, filledQuantity, cashTotal, positionCost, latestFill, contractActivity, onNavigate }: Props) {
  return <>
